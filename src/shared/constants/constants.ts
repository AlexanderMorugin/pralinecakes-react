...
export const META_MAIN_DESCRIPTION = 'Дессерты, торты и пирожные для кафе, баров, ресторанов, кофеен, пекарен и театров';
...
export const META_CONTACTS_DESCRIPTION = 'Москва, Рублевское шоссе, 52а. Мы находимся в ТЦ «Западный» на третьем этаже.';
...
export const META_DELIVERY_DESCRIPTION = '<Бесплатно доставляем пирожные и торты по Москве и ближайшие пригородные районы.';
