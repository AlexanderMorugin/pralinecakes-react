...
export const pastryData = [
  ...
  },
  {
    ...
    title: 'Кейк попс',
    description:
      'Небольшое шоколадное бисквитное пирожное в глазури на палочке',
    ingredients:
      'Шоколад 53%, сливки 33%, сахар, мука пшеничная, яйцо куриное, джем абрикосовый, какао, масло растительное',
    protein: 6.4,
    fat: 21.2,
    carbohydrates: 46.7,
    calories: 369,
  ...
  },
  {
    ...
    title: 'Птичье молоко',
    description:
      'Воздушное суфле на бисквитном корже под слоем горького шоколада',
    ingredients:
      'Масло сливочное, сахар, сгущенное молоко гост, шоколад 72%, мука пшеничная, яйцо куриное, масло растительное, агар-агар, лимонная кислота',
    protein: 8.3,
    fat: 23.8,
    carbohydrates: 56.6,
    calories: 473,
  ...
  },
  {
    ...
    title: 'Чизкейк лайм',
    description: 'Испеченный сырный торт с добавлением лайма',
    ingredients:
